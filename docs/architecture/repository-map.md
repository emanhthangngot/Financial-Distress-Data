...
|---|---|---|
| `src/collectors/`, `src/generator/`, `src/generators/`, `src/streaming/`, `src/transforms/`, `src/quality/`, `src/catalog/`, `src/metadata/`, `src/io/`, `src/jobs/`, `src/security/` | data_engineer | Phase 1 local lakehouse |
