...
* [problem_factory.py](../src/generator/problem_factory.py): Bộ sinh dữ liệu kiểm thử theo rubric bài tập, hỗ trợ tạo các kịch bản lỗi dữ liệu ngẫu nhiên để kiểm tra sức chịu đựng của Data Quality Engine.
