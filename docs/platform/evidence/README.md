# the platform evidence captures
...
| Deployable image catalog (build source of truth) | `configs/platform-deployables.yaml` |
| Shared build/sign CI workflow | `.github/workflows/platform-ci.yaml` |
