...
- command: `python scripts/run_phase5_warmup_measurement.py --warm-replicas 2 --output docs/platform/evidence/llm/warmup.json`
...
```
$ python scripts/run_phase5_warmup_measurement.py --warm-replicas 2 --output docs/platform/evidence/llm/warmup.json
{
