...
- command: `.venv-platform/bin/python3 -c "from src.llm.model_server import call_chat_completion; print(call_chat_completion('http://localhost:18080', [{'role':'user','content':'Say hi in 2 words.'}], max_tokens=16))"` (port-forwarded to the live `fd-chat-model-predictor-00001-private` Service)
