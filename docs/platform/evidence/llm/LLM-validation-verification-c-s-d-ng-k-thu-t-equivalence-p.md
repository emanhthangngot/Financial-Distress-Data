...
Proves `tests/platform/verification/test_equivalence_boundary.py` exercises
...
- command: `pytest tests/platform/verification/test_equivalence_boundary.py -v`
...
```
$ pytest tests/platform/verification/test_equivalence_boundary.py tests/platform/verification/test_idempotency.py tests/platform/verification/test_web_api_adapters.py -q
...................                                                      [100%]
19 passed in 1.30s
```
