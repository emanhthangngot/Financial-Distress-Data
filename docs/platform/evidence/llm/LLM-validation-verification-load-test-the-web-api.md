...
- actual_result: 1352 requests, 0 failures, median 51ms, p95 140ms, p99 330ms, max 490ms, throughput 15.06 req/s at 20 concurrent users; report at `docs/platform/evidence/llm/locust-report.html`, raw stats at `docs/platform/evidence/llm/locust_stats.csv`
