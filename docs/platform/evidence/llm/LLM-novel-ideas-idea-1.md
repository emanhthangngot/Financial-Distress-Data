...
- command: `.venv-platform/bin/python -m pytest -q tests/platform/verification/test_llm_novel_ideas.py -k embedding_registry`
...
`tests/platform/verification/test_llm_novel_ideas.py`.
