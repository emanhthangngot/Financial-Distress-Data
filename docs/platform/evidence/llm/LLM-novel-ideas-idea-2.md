...
- command: `.venv-platform/bin/python -m pytest -q tests/platform/verification/test_llm_novel_ideas.py -k citation_guard`
...
decision contract is exercised by `tests/platform/verification/test_llm_novel_ideas.py`.
