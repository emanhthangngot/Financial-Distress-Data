...
- versions: coordinator/feature-agent/drift-agent and MCP images from the the platform Artifact Registry digests; model=qwen2.5-0.5b-instruct; data=stream_market_features:last_price with synthetic market_stress rows AAA/BBB; embedding=not-used-by-this-runtime-path
...
The recording rule `platform:llm_safety_pii_prompt_catches_total:rate5m` was also
