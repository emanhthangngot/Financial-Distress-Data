...
- command: `kubectl exec sandbox-negative-probe -n agents-sandbox -- curl -fsS http://feature-mcp.platform-data.svc.cluster.local/healthz` and the live feature-agent request
