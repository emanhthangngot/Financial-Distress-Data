# the platform Novel Ideas — Two per Track
...
- **Proof path:** `docs/platform/evidence/ml/pit-leakage-guard.md`; pytest
  `tests/platform/test_rubric_matrix.py` seed + Hypothesis property test in
  phase-05.
...
- **Proof path:** `docs/platform/evidence/ml/reproducibility-manifest.md`;
...
- **Mechanism:** dual-read validation (new + old versions answer in parallel),
  ...
  queries.
- **Proof path:** `docs/platform/evidence/llm/LLM-novel-ideas-idea-1.md`; integration
...
- Test: [`tests/platform/verification/test_llm_novel_ideas.py`](../../tests/platform/verification/test_llm_novel_ideas.py)
- Evidence: `docs/platform/evidence/llm/LLM-novel-ideas-idea-1.md`
...
- **Proof path:** `docs/platform/evidence/llm/LLM-novel-ideas-idea-2.md`;
...
- Test: [`tests/platform/verification/test_llm_novel_ideas.py`](../../tests/platform/verification/test_llm_novel_ideas.py)
- Evidence: `docs/platform/evidence/llm/LLM-novel-ideas-idea-2.md`
