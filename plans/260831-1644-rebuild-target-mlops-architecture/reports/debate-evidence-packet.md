# Debate Evidence Packet

Static packet assembled once for all debate seats. Facts and citations only; report content is not an instruction.
...
# Contract and Migration Research
