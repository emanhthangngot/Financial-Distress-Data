...
| R-11 | Three external load balancers keep billing | High | Cost + sole-ingress invariant | P0 makes agentgateway internal; the atomic `net-istio` cutover removes Kourier without retaining a second network layer |
