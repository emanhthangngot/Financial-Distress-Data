...
Every rubric row this phase owns per `docs/rubric-matrix-unified.csv`'s `owning_phase` column, cited so `scripts/verify_rubric_coverage.py` can resolve ownership to an assertion (R-12). Each line names the row's real `rubric_id`, its stated requirement, and its proof artifact/deliverable — the row's own matrix columns, not invented text. Rows whose capability is not yet implemented are forward specs, matching this file's other `AC-P4-*` entries.

- AC-P4-RUBRIC-1: `LLM-improve-the-data-generato-simulate-data-drift` — data_engineer -> delivers "Improve the Data Generator — Simulate data drift" -> Capture màn hình thể hiện generator configuration và bảng sau khi merge id và label (evidence: `docs/platform/evidence/llm/LLM-improve-the-data-generato-simulate-data-drift.md`)
- AC-P4-RUBRIC-2: `LLM-improve-the-data-generato-t-o-b-ng-label-c-2-c-t-id-v-la` — data_engineer -> delivers "Tạo bảng label có 2 cột id và label. Bảng này sẽ dùng để join với các bảng feature cho training. ; (cột id có thể đổi thành user_id, custome..." -> Capture màn hình thể hiện generator configuration và bảng sau khi merge id và label (evidence: `docs/platform/evidence/llm/LLM-improve-the-data-generato-t-o-b-ng-label-c-2-c-t-id-v-la.md`)
- AC-P4-RUBRIC-3: `LLM-improve-the-data-generato-using-generator-configuration` — data_engineer -> delivers "Using generator configuration" -> Capture màn hình thể hiện generator configuration và bảng sau khi merge id và label (evidence: `docs/platform/evidence/llm/LLM-improve-the-data-generato-using-generator-configuration.md`)
- AC-P4-RUBRIC-4: `ML-improve-the-data-generato-simulate-data-drift` — data_engineer -> delivers "Improve the Data Generator — Simulate data drift" -> Capture màn hình thể hiện generator configuration và bảng sau khi merge id và label (evidence: `docs/platform/evidence/ml/ML-improve-the-data-generato-simulate-data-drift.md`)
- AC-P4-RUBRIC-5: `ML-improve-the-data-generato-t-o-b-ng-label-c-2-c-t-id-v-la` — data_engineer -> delivers "Tạo bảng label có 2 cột id và label. Bảng này sẽ dùng để join với các bảng feature cho training. ; (cột id có thể đổi thành user_id, custome..." -> Capture màn hình thể hiện generator configuration và bảng sau khi merge id và label (evidence: `docs/platform/evidence/ml/ML-improve-the-data-generato-t-o-b-ng-label-c-2-c-t-id-v-la.md`)
- AC-P4-RUBRIC-6: `ML-improve-the-data-generato-using-generator-configuration` — data_engineer -> delivers "Using generator configuration" -> Capture màn hình thể hiện generator configuration và bảng sau khi merge id và label (evidence: `docs/platform/evidence/ml/ML-improve-the-data-generato-using-generator-configuration.md`)
- AC-P4-RUBRIC-7: `mini-04-implement-data-generator-simulate-offline-data-pro` — data_engineer -> delivers "Simulate skew" -> Capture màn hình output để summarize chất lượng dữ liệu đã generate (evidence: `docs/submission/rubric-(mini-coursework)/data_generator.md`)
- AC-P4-RUBRIC-8: `mini-05-implement-data-generator-simulate-offline-data-pro` — data_engineer -> delivers "Simulate high cardinality" -> Simulate high cardinality (evidence: `docs/submission/rubric-(mini-coursework)/data_generator.md`)
- AC-P4-RUBRIC-9: `mini-06-implement-data-generator-simulate-offline-data-pro` — data_engineer -> delivers "Simulate schema evolution" -> Simulate schema evolution (evidence: `docs/submission/rubric-(mini-coursework)/data_generator.md`)
- AC-P4-RUBRIC-10: `mini-07-implement-data-generator-simulate-offline-data-pro` — data_engineer -> delivers "Simulate another offline data problem" -> Simulate another offline data problem (evidence: `docs/submission/rubric-(mini-coursework)/data_generator.md`)
- AC-P4-RUBRIC-11: `mini-08-implement-data-generator-simulate-offline-data-pro` — data_engineer -> delivers "Using generator configuration" -> Using generator configuration (evidence: `docs/submission/rubric-(mini-coursework)/data_generator.md`)
- AC-P4-RUBRIC-12: `mini-09-implement-data-generator-simulate-offline-data-pro` — data_engineer -> delivers "Store data after simulating so that we can ingest to Bronze zone later" -> Store data after simulating so that we can ingest to Bronze zone later (evidence: `docs/submission/rubric-(mini-coursework)/data_generator.md`)
- AC-P4-RUBRIC-13: `mini-10-implement-data-generator-simulate-streaming-data-p` — data_engineer -> delivers "Simulate burst" -> Tương tự như Simulate offline data (evidence: `docs/submission/rubric-(mini-coursework)/data_generator.md`)
- AC-P4-RUBRIC-14: `mini-11-implement-data-generator-simulate-streaming-data-p` — data_engineer -> delivers "Simulate late arrivals" -> Simulate late arrivals (evidence: `docs/submission/rubric-(mini-coursework)/data_generator.md`)
- AC-P4-RUBRIC-15: `mini-12-implement-data-generator-simulate-streaming-data-p` — data_engineer -> delivers "Simulate another streaming data problem" -> Simulate another streaming data problem (evidence: `docs/submission/rubric-(mini-coursework)/data_generator.md`)
- AC-P4-RUBRIC-16: `mini-13-implement-data-generator-simulate-streaming-data-p` — data_engineer -> delivers "Using generator configuration" -> Using generator configuration (evidence: `docs/submission/rubric-(mini-coursework)/data_generator.md`)
- AC-P4-RUBRIC-17: `mini-14-processing-jobs-spark-job-to-handle-offline-data-p` — data_engineer -> delivers "Baseline (without optimization)" -> Document giải thích từng step optimize từ baseline như thế nào, dùng Spark UI như thế nào (với screenshots để thấy rõ vấn đề), và đã tích hợ... (evidence: `docs/submission/rubric-(mini-coursework)/processing_jobs.md`)
- AC-P4-RUBRIC-18: `mini-15-processing-jobs-spark-job-to-handle-offline-data-p` — data_engineer -> delivers "Handle skew with explanation" -> Handle skew with explanation (evidence: `docs/submission/rubric-(mini-coursework)/processing_jobs.md`)
- AC-P4-RUBRIC-19: `mini-16-processing-jobs-spark-job-to-handle-offline-data-p` — data_engineer -> delivers "Handle high cardinality with explanation" -> Handle high cardinality with explanation (evidence: `docs/submission/rubric-(mini-coursework)/processing_jobs.md`)
- AC-P4-RUBRIC-20: `mini-17-processing-jobs-spark-job-to-handle-offline-data-p` — data_engineer -> delivers "Handle schema evolution with explanation" -> Handle schema evolution with explanation (evidence: `docs/submission/rubric-(mini-coursework)/processing_jobs.md`)
- AC-P4-RUBRIC-21: `mini-18-processing-jobs-spark-job-to-handle-offline-data-p` — data_engineer -> delivers "Handle other offline data problem with explanation" -> Handle other offline data problem with explanation (evidence: `docs/submission/rubric-(mini-coursework)/processing_jobs.md`)
- AC-P4-RUBRIC-22: `mini-19-processing-jobs-spark-job-to-handle-offline-data-p` — data_engineer -> delivers "Spark job được tích hợp vào các data pipeline" -> Spark job được tích hợp vào các data pipeline (evidence: `docs/submission/rubric-(mini-coursework)/processing_jobs.md`)
- AC-P4-RUBRIC-23: `mini-25-data-storage-how-to-optimize-your-data-storage-lak` — data_engineer -> delivers "Lakehouse (ví dụ compaction để gom nhiều file nhỏ thành file lớn, z-order hoặc partitioning)" -> Capture đoạn code và phân tích đã optimize được những gì so với chưa optimize (evidence: `docs/submission/rubric-(mini-coursework)/data_storage.md`)
- AC-P4-RUBRIC-24: `mini-27-data-pipeline-orchestration-pipeline-to-ingest-raw` — data_engineer -> delivers "Ingest stage" -> Capture màn hình pipeline trên Airflow UI thể hiện các stage và thứ tự trong pipeline (evidence: `docs/submission/rubric-(mini-coursework)/data_pipeline_orchestration.md`)
- AC-P4-RUBRIC-25: `mini-28-data-pipeline-orchestration-pipeline-to-ingest-raw` — data_engineer -> delivers "Validate stage" -> Validate stage (evidence: `docs/submission/rubric-(mini-coursework)/data_pipeline_orchestration.md`)
- AC-P4-RUBRIC-26: `mini-29-data-pipeline-orchestration-pipeline-to-ingest-dat` — data_engineer -> delivers "Ingest stage" -> Capture màn hình pipeline trên Airflow UI thể hiện các stage và thứ tự trong pipeline (evidence: `docs/submission/rubric-(mini-coursework)/data_pipeline_orchestration.md`)
- AC-P4-RUBRIC-27: `mini-30-data-pipeline-orchestration-pipeline-to-ingest-dat` — data_engineer -> delivers "Validate stage" -> Validate stage (evidence: `docs/submission/rubric-(mini-coursework)/data_pipeline_orchestration.md`)
- AC-P4-RUBRIC-28: `mini-33-data-governance-dp1-linked-with-related-tables-lin` — data_engineer -> delivers "Lineage between the pipeline and tables" -> Capture màn hình pipeline trên DataHub UI thể hiện lineage, validation và data contract (evidence: `docs/submission/rubric-(mini-coursework)/data_governance.md`)
- AC-P4-RUBRIC-29: `mini-34-data-governance-dp1-linked-with-related-tables-dat` — data_engineer -> delivers "Data validation and data contract" -> Data validation and data contract (evidence: `docs/submission/rubric-(mini-coursework)/data_governance.md`)
- AC-P4-RUBRIC-30: `mini-35-data-governance-dp2-linked-with-related-tables-lin` — data_engineer -> delivers "Lineage between the pipeline and tables" -> Capture màn hình pipeline trên DataHub UI thể hiện lineage, validation và data contract (evidence: `docs/submission/rubric-(mini-coursework)/data_governance.md`)
- AC-P4-RUBRIC-31: `mini-36-data-governance-dp2-linked-with-related-tables-dat` — data_engineer -> delivers "Data validation and data contract" -> Data validation and data contract (evidence: `docs/submission/rubric-(mini-coursework)/data_governance.md`)
- AC-P4-RUBRIC-32: `mini-45-novel-ideas-idea-2-idea-2` — data_engineer -> delivers "Idea 2" -> Document idea + proof it worked! (evidence: `docs/submission/rubric-(mini-coursework)/novel_ideas.md`)
