...
| 5 | [Close CI/CD, security and verification gates](./phase-05-close-ci-cd-security-and-verification-gates.md) | 23 | 1.5 | Blocked — static CI/test gates pass; release and runtime evidence unavailable |
