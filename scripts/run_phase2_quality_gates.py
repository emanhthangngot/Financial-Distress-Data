...
from phase2_ci.catalog import CatalogError, validate_catalog
...
def run_phase2_quality_gates(
    *,
    ...
    test_command = (
        ...
        "tests/phase2/test_artifact_path_contract.py",
        "tests/phase2/test_deployable_catalog.py",
        "-m",
        "not slow",
    )
