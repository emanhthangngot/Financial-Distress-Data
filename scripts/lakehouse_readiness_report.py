...
from scripts.audit_lakehouse_evidence import audit_evidence
from scripts.check_lakehouse_services import check_services

PROJECT_LABEL = "production-inspired local-first lakehouse foundation with runtime evidence"
QUALITY_GATE_COMMAND = (sys.executable, "scripts/run_lakehouse_quality_gates.py")
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        action="store_true",
        help="Also run scripts/run_lakehouse_quality_gates.py and include the result.",
    )
